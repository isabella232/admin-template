...
**TKTK: Describe admin-template here.**
...
```
* * * * * ubuntu bash /home/ubuntu/apps/admin_template/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|admin-template|tweet|`location`||
|admin-template|facebook|`location`||
|admin-template|email|`location`||
|admin-template|new-comment||
|admin-template|open-share-discuss||
|admin-template|close-share-discuss||
|admin-template|summary-copied||
|admin-template|featured-tweet-action|`action`|
|admin-template|featured-facebook-action|`action`|
